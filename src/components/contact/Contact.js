...
//  import { GetContries, IpAddress, SendEmail } from './';
...
function App() {
    ...
    return (
        <>
            {/* <Toast />
            < className="container flex-colo py-12 mx-auto min-h-screen sm:py-2 px-4 ">
                {loading ? (
                    <Loading /> */}
            <div class="container">
                <form
                    onSubmit={submitHandler}
                    className="box-1 bg-white pt-12 pb-6 sm:px-5 px-10"
                >
                    ...
                    <div className="my-6">
                        ...
                        <textarea
                            ...
                            rows={3}
                            className="mt-2 w-100 border-2 border-border py-4 placeholder:text-gray px-6 text-main rounded-md"
                        />
                    ...
                    <button
                        ...
                        className="w-100 border-2 border-main hover:bg-white trans bg-main mt-6 rounded-md tracking-widest py-2 font-subMain font-bold"
                    >
