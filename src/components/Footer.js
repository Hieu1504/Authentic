          ...
          <div class="row">
            <div class="col-md-6 col-lg-4 col-sm-6 mb-5 mb-lg-0 text-center text-sm-left mr-auto">
              <div class="footer-widget">
                <div>
                  <img href="#" className="w-36" src={logo} alt="logo.png" />
                </div>
                <p class="lead">Bán đồ uy tín chất lượng</p>
                <div class="">
                  <p class="mb-0"><strong>Location : </strong>19 Lê Thanh Nghị</p>
                  <p><strong>Support Email : </strong> vtieducation.com</p>
                </div>
              </div>
            </div>
